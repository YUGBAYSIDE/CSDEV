class Tree{
  constructor(x,z){
      ...
      */
      /* Challenge 
         Make the tree fall down when the user clicks on the snowman.
  ...
  falldown(){
      // In addition to check for the flag ensure the "rotation" angle is greater then -70
    if(this.fall && this.r > -70){
      this.r += this.dr;
